...
const Navbar = () => {
    ...
    return (
        <nav className={`${location.pathname === '/admin' && 'hidden'} shadow-sm sticky w-full text-gray-800 bg-white`}>
            <div className="max-w-7xl px-4 sm:px-6 m-auto py-2">
                ...
                <div className="md:hidden duration-700">
                    {
                        isOpenMenu ? <MobileNav isOpenMenu={isOpenMenu}/> : null
                    }
                </div>
            </div>
        </nav >
